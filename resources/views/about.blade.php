...
@section('content')
	    ...
	    <div class="well">
		    <div class="row">
		        ...
		        <div class="col-md-4">
	                <?php if (Auth::check()): ?>	
			            <a class="btn btn-lg btn-primary btn-block" href="{{ SITEROOT }}/account/project/details/0/new" style="text-decoration: none;">Create now!</a>
					<?php else: ?>                    	
			            <a class="btn btn-lg btn-primary btn-block" href="{{ SITEROOT }}/auth/register" style="text-decoration: none;">Join now!</a>
			        <?php endif; ?>
		        </div>
		    </div>
	        <!-- /.row -->
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <img class="img-responsive col-md-6" style="float: right; padding: 0; margin-top: 3px; margin-left: 12px; margin-bottom: 5px;" src="{{ SITEROOT }}/images/sushil_at_lincoln_memorial.jpg" alt="Sushil at the Lincoln Memorial">
                <div>
                    <ul>
