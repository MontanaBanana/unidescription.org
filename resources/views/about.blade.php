		...
		<div class="row blade" style="padding-bottom: 0;">
                    ...
                    <h2 class="page-header">About The UniD Project<br/><span style="font-size: 16px;">Our backstory, our mission, and our plans for future development</span></h2>
                            <div class="col-md-12">
                                ...
                                <div style="float: right; align: right; width: 500px; max-width: 100%; margin-left: 15px;"><iframe width="500" height="281" src="https://www.youtube.com/embed/nxbgvqkWLh0" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe> <p class="caption">Michele Hartley, Media Accessibility Coordinator for Harpers Ferry Center, the design hub of the National Park Service, gave this dynamic overview of The UniDescription Project at Fedstival 2017 (on Sept. 22, 2017).</p></div>
