...
@section('content')
		...
		<div class="row">
			<div class="container">
				<div class="col-md-12">
					<h3>Standards for Audio Descriptions</h3>
		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				<div>
					...
					<select name="voice" id="choose_voice"></select>
				</div>
				-->
			</div>
		</div>
		...
		<div class="row">
			<div class="container">
				<div class="col-md-6">
					<div class="row">
						<div class="col-md-6">
							...
							<p>Lorem ipsum dolor site amet, consect.</p>
						</div>
						<div class="col-md-6">
							<div class="alert alert-success">
								<h3>Success!</h3>
								<p>Your content looks good.</p>
							</div>
						</div>
					</div>
				...
				<div class="col-md-6">
					<h3>Standards for 30 Second Overview</h3>
					<p>Click on the subjects below to read more about best practices for audio descriptions.</p>
					<div class="list-group">
						<a class="list-group-item disabled" data-toggle="modal" data-target="#whatyouseeModal"
