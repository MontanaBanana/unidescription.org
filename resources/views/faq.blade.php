        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">FAQ
                    <small>about UniDescription</small>
                </h1>
                <ol class="breadcrumb">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">What are audio descriptions?</a>
                            </h4>
                        </div>
...
<p>Descriptions are delivered through a wireless earphone to permit people who are blind or have low vision to sit anywhere in the audience. The Standards for Audio Description reflect audio description’s origin as a means of making live theatre performances accessible; however, the spirit of these principles applies to almost all audio description situations. </p>

<p>Other art forms and media call for variations from these original principles, which are discussed in separate sections later in this document. The Code of Professional Conduct for Describers, near the end of this document, addresses the responsibiities of audio describers and trainers in terms of obligations to clients and consumers, privacy and confidentiality, behavior, business practices, and continuing development.</p>

<p>Source: <a href="http://www.nps.gov/hfc/acquisition/pdf/audio-description/shared/attach-a.pdf">Standards for Audio Description and Code of Professional Conduct for Describers</a></p>
                            </div>
                        </div>
                    </div>
                    <!-- /.panel -->
