    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <div class="fill" style="background-image:url('{{ SITEROOT }}/slideshow/interview.jpg');"></div>
            ...
            <div class="item">
                <div class="fill" style="background-image:url('{{ SITEROOT }}/slideshow/learning.jpg');"></div>
                <div class="carousel-caption">
