...
foreach ($libraries as $lib):
    ...
    <tr>
        ...
        <?php if ($lib->user_id == Auth::user()->id || Auth::user()->id == 24): ?>
            <a href="/library/updateword/<?php echo $lib->id; ?>" class="btn btn-sm btn-primary btn-inline" style="width: 120px;"><i id="plus-icon" class="fa fa-plus fa-fw"></i> UPDATE</a>
        <?php endif; ?>
        </td>
        <td align="right">
        <?php if ($lib->user_id == Auth::user()->id || Auth::user()->id == 24): ?>
