...
<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <p>As the owner of the {{ $project->title }} project on UniDescription.org, you must authorize the app to be built. Please go to http://www.unidescription.org/phonegapbuild/authorize and follow the instructions to allow the app to be built. Thanks!</p>
