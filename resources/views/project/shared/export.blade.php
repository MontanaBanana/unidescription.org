    ...
    <div class="panel-body">
        ...
        @if ($project->id)
          <ul style="list-style: none; padding-left: 0;">
            ...
            <li><a href="/account/project/export/{{ $project->id }}" class="btn btn-lg btn-primary btn-icon" style="width: 100%;" target="_blank" title="Preview App ({{ $project->active_components() }} / {{ $project->active_components() + $project->inactive_components() }} components are completed and will display)"><span class="fa fa-eye"></span> Preview App ({{ $project->active_components() }} / {{ $project->active_components() + $project->inactive_components() }} ACTIVE)</a></li>
            <li><a href="/account/project/export_text/{{ $project->id }}" class="btn btn-lg btn-primary btn-icon" style="width: 100%;" target="_blank"><span class="fa fa-file"></span> Download Text Export</a></li>
			...
			<li><a href="/account/project/zip/{{ $project->id }}" class="btn btn-lg btn-primary btn-icon" style="width: 100%;" target="_blank"><span class="fa fa-file-code"></span> Download HTML Export</a></li>
